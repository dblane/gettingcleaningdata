...
## Now we can produce the codebook which can be used to easily reproduce the tidy data process.
## The purpose of this codebook is to give readers a clear understanding of the process 
## used to clean this data and provide an output of tidydata.
